...
const projectsRegistry: Record<string, ProjectDetails> = {
  "wardrobe-ai": {
    description:
      "Wardrobe-AI is a cross-platform mobile application that uses artificial intelligence for virtual clothing simulation. Designed with a serverless architecture for real-time inference.",
    stackJson: {
      Framework: "Flutter",
    ...
    githubUrl: "https://github.com/luis-valverde120/wardrobe-ai",
  },
  "t-world": {
    description:
      "T-World is a high-performance Full-Stack E-commerce platform for themed clothing. Designed with Server Actions to reduce latency and a strict relational data schema to manage complex inventories.",
    stackJson: {
    ...
    githubUrl: "https://github.com/luis-valverde120/t-world",
  },
  zyrex: {
    description:
      "Zyrex is a digital marketplace designed to empower artisans in Tulcan. Built on a robust Node.js architecture with Server-Side Rendering (SSR) to ensure optimal SEO indexing.",
    stackJson: {
      Runtime: "Node.js",
    ...
    githubUrl: "https://github.com/luis-valverde120/zyrex",
  },
  organigrama: {
    description:
      "Hierarchical structure management system built under the Hexagonal Architecture pattern. Guarantees complete decoupling between business rules (Domain), database, and user interface.",
    stackJson: {
    ...
    githubUrl: "https://github.com/luis-valverde120/organigrama",
  },
  "netlife-challenge": {
    description:
      "Automated Competitive Intelligence tool developed for the Netlife Innovation Challenge. A complete data pipeline that extracts, processes, and analyzes the ISP market using Scraping and Generative AI.",
    stackJson: {
    ...
    githubUrl: "https://github.com/compumax-ec/netlife",
  },
};
