...
export default function About() {
  ...
  return (
    <div
      className="bg-black/40 backdrop-blur-xl border border-white/20 rounded-2xl shadow-2xl about-window-panel w-full h-full flex flex-col relative"
      ref={containerRef}
    >
      ...
      <div className="p-6 md:p-8 font-mono text-sm overflow-y-auto flex-1 flex flex-col lg:flex-row gap-8 lg:gap-12">
        ...
        <div className="w-full lg:w-[45%] flex flex-col gap-4">
          ...
          <div
            className={`neofetch-output flex flex-col xl:flex-row gap-6 mt-2 transition-opacity ${showNeofetchOutput ? "opacity-100" : "opacity-0 invisible"}`}
          >
            ...
            <div className="flex flex-col gap-1 w-full text-xs sm:text-sm text-gray-300">
              <div className="mb-2">
                <span className="text-[#a855f7] font-bold">luis</span>
                <span className="text-white">@</span>
                <span className="text-[#a855f7] font-bold">valverde</span>
                <div className="text-white">-------------</div>
              </div>
              <div>
                <span className="text-[#a855f7] font-bold">OS</span>: Software
                Engineer
              </div>
              <div>
                <span className="text-[#a855f7] font-bold">Host</span>: UPEC CS
                7th Sem
              </div>
              <div>
                <span className="text-[#a855f7] font-bold">Kernel</span>:
                Backend Architecture
              </div>
              <div>
                <span className="text-[#a855f7] font-bold">Uptime</span>:
                24/7/365
              </div>
              <div>
                <span className="text-[#a855f7] font-bold">Packages</span>:
                Node, FastAPI, Next
              </div>
              <div>
                <span className="text-[#a855f7] font-bold">Shell</span>: bash
              </div>
              <div>
                <span className="text-[#a855f7] font-bold">Theme</span>:
                Cyber-Architect
              </div>
        ...
        <div className="w-full lg:w-[55%] flex flex-col gap-6 lg:pl-8 lg:border-l lg:border-white/10 pt-6 lg:pt-0 border-t border-white/10 lg:border-t-0">
          ...
          <div className="space-y-4 text-sm text-gray-300 font-sans leading-relaxed">
            <p className="about-text-p">
              I’m a Software Engineer and a 7th-semester Computer Science
              student at UPEC, focused on designing secure and scalable backend
              systems.
            </p>
            <p className="about-text-p">
              Beyond writing code, I build tech communities. I’m a founding
              member of the IEEE UPEC branch and have contributed to organizing
              AI events and hackathons. I’ve also been involved in
              university-level decision-making spaces, strengthening my ability
              to think critically, communicate technical ideas, and evaluate
              complex systems.
            </p>
            <p className="about-text-p">
              I approach software architecture the same way I approach
              competitive chess and heavy strength training: with pure strategy,
              consistency, and a focus on{" "}
